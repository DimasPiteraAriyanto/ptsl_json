   ...
   <div class="row">
      ...
      <div class="col-md-12 col-sm-12 ">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="nama_alas_hak" value="{{$alas_hak->nama_alas_hak}}" id="nama_alas_hak" class="form-control">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="no_alas_hak" id="no_alas_hak" value="{{$alas_hak->no_alas_hak}}" class="form-control">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" class="form-control has-feedback-left" value="{{$alas_hak->tanggal_alas_hak}}" id="tanggal_alas_hak" name="tanggal_alas_hak" required="required" aria-describedby="inputSuccess2Status4">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="pembuat_alas_hak" value="{{$alas_hak->pembuat_alas_hak}}" id="pembuat_alas_hak" class="form-control">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="luas_yang_dimohon" value="{{$alas_hak->luas_yang_dimohon}}" id="luas_yang_dimohon" class="form-control">
            </div>
          </div>  
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="utara" id="utara" value="{{$alas_hak->utara}}" class="form-control">
            </div>
          </div>  
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="timur" id="timur" value="{{$alas_hak->timur}}" class="form-control">
            </div>
          </div>  
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="selatan" id="selatan" value="{{$alas_hak->selatan}}" class="form-control">
            </div>
          </div>  
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="barat" id="barat" value="{{$alas_hak->barat}}" class="form-control">
            </div>
          </div>      
          ...
          @if($jid == 4 || $jid == 8)
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="harga" id="harga" value="{{$alas_hak->harga}}" class="form-control">
                </div>
              </div>
          @endif 
          <!-- BATAS -->
          ...
          @if($jid == 6)
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="nama_almarhum" value="{{$alas_hak->nama_almarhum}}" id="nama_almarhum" class="form-control">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" class="form-control has-feedback-left" value="{{$alas_hak->tanggal_meninggal}}" id="tanggal_meninggal" name="tanggal_meninggal" required="required" aria-describedby="inputSuccess2Status4">
                  <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="desa_meninggal" value="{{$alas_hak->desa_meninggal}}" id="desa_meninggal" class="form-control">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="kecamatan_meninggal" value="{{$alas_hak->kecamatan_meninggal}}" id="kecamatan_meninggal" class="form-control">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="kabupaten_meninggal" value="{{$alas_hak->kabupaten_meninggal}}" id="kabupaten_meninggal" class="form-control">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="desa_tinggal" id="desa_tinggal" value="{{$alas_hak->desa_tinggal}}" class="form-control">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="kecamatan_tinggal" value="{{$alas_hak->kecamatan_tinggal}}" id="kecamatan_tinggal" class="form-control">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="kabupaten_tinggal" value="{{$alas_hak->kabupaten_tinggal}}" id="kabupaten_tinggal" class="form-control">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" name="perkawinan_dengan" value="{{$alas_hak->perkawinan_dengan}}" id="perkawinan_dengan" class="form-control">
                </div>
              </div>
          @endif          
          <!-- BATAS -->
