...
<script type="text/javascript">
	...
	function editRecord(id) {
  		$(document).on('click', '.btn-edit', function() {
  			$('.modal-title').text('Form Ubah Penyanggah')
        	$('.f-add').modal('show');
        	$('.add').hide();
            $('.update').show();
    	});
    	...
    	$.ajax({
            type: 'GET',
            url: SITEURL + "json/penyanggah/" + id,
            ...
            success: function(data) {
	        	...
	        	$('#nama_penyanggah').val(data.nama_penyanggah)
            	...
            	var clickHandler = function(e){
			        $.ajax({
			            ...
			            data: {
		                    'nik' : $('#nik').val(),
		                    'no_telp' : $('#no_telp').val(),
		                    'nama_penyanggah' : $('#nama_penyanggah').val(),
	...
	$(document).ready( function () {
		...
		$(document).on('click', '.m-add', function() {
            ...
            $('#form-add')[0].reset();
            $('.f-add').modal('hide');
  			$('.modal-title').text('Form Tambah Penyanggah')
        	$('.f-add').modal('show');
        	$('.add').show();
            $('.update').hide();
    	});
	    ...
	    $('.modal-footer').on('click', '.add', function() {
	        ...
	        var nama_penyanggah = $('#nama_penyanggah').val();
	        ...
	        var jenis_penyanggah = $('#jenis_penyanggah').val();
	        ...
	        data.append('nama_penyanggah', nama_penyanggah);
	        ...
	        data.append('jenis_penyanggah', jenis_penyanggah);
