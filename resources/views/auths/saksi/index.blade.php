...
<script type="text/javascript">
	...
	function editRecord(id) {
  		$(document).on('click', '.btn-edit', function() {
  			$('.modal-title').text('Form Ubah Saksi')
        	$('.f-add').modal('show');
        	$('.add').hide();
            $('.update').show();
    	});
	...
	$(document).ready( function () {
		...
		$(document).on('click', '.m-add', function() {
            ...
            $('#form-add')[0].reset();
            $('.f-add').modal('hide');
  			$('.modal-title').text('Form Tambah Saksi')
        	$('.f-add').modal('show');
        	$('.add').show();
            $('.update').hide();
    	});
	    ...
	    $('.modal-footer').on('click', '.add', function() {
	        ...
	        var jenis_saksi = $('#jenis_saksi').val();
	        ...
	        data.append('nama_saksi', nama_saksi);
	        ...
	        data.append('jenis_saksi', jenis_saksi);
